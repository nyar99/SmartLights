...
SPOTIPY_CLIENT_ID = "18a1ffa992ce4a27b7f11819f9dcdf45"
SPOTIPY_CLIENT_SECRET = "183f6d0ffca74f3caf89fab6000a5b68"
SPOTIPY_REDIRECT_URI = "http://192.168.1.113:8080/"
...
def index():
    ...
    song_info = "failure state"
    if not track is None:
        track_uri = track['item']['uri']
        song_info = str(spotify.audio_features([track_uri[track_uri.rfind(':') + 1:]])[0]['tempo'])
...
if __name__ == '__main__':
    app.run(host = '192.168.1.113', port=int(os.environ.get("PORT", 8080)))
